	...
	<main
		...
		<section>
			<form
				...
				@submit.prevent="">
				<p class="text-[3.2rem] font-w700 mb-[3.2rem]">Register</p>
				<label for="name" :class="labelStyles">Name</label>
				<input type="text" id="name" :class="inputStyles" class="mb-[.3rem]" v-model="loginData.email" />
				...
				<label for="password" :class="labelStyles">Create password</label>
				<div
				...
				<p class="text-[#696868] text-[1.4rem] text-center">
					...
					<NuxtLink to="/login" class="underline text-[#111827] font-w700">Login</NuxtLink>
				</p>
			</form>
		</section>
